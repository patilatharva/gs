  ...
  describe('when there is already a body', () => {
    it('replaces the footer', () => {
      ...
      **Test Plan:**
      ...
      ![CleanShot 2024-02-08 at 21 18 49@2x](https://github.com/patilatharva/gs/assets/22798229/3821e8dc-d6df-4e1d-bd4b-2ed5ccf7aec9)
...
=======
      This stack was auto-generated by [gs](https://github.com/patilatharva/gs).
>>>>>>> 2e269cbc (Print the PR branch's stack in the footer.)
      `;
